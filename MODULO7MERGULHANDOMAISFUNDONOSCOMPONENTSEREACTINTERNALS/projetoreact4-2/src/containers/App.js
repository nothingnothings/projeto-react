...
// {/* <AuthContext.Provider>   */}    -------> É USADO COM A FEATURE 'CONTEXT' do REACT... --> é usado para EVITAR PASS DE PROPS ENTRE LAYERS DESNECESSÁRIOS (2-3-4 layers, props passados de A à D, por exemplo)... 
// {/* <AuthContext.Provider>   */}  ------> O QUE INTERESSA É O PROP de 'value' definido no CALL desse component, ali embaixo... (o valor '''DEFAULT''' desse objeto 'context', definido LÁ EM 'auth-context.js', NÃO IMPORTA NEM UM POUCO, QUANDO O COMPARAMOS AO PROP 'value' ---> prop value SEMPRE SERÁ APLICADO. O 'default' SÓ É APLICADO se o prop 'value' não estiver definido.)
...
return (
  ...
  {this.state.showCockpit ? (
          <Cockpit //usará O CONTEXT do 'AuthContext.Provider'...
  ...
  {persons} 
  {/* 'persons' também USARÁ O 'context' do 'AuthContext.Provider'.... */}
  </AuthContext.Provider> 
  </div>
  //</WithClass>
);
