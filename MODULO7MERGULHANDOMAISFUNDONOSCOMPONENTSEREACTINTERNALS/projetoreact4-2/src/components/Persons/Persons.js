...
// }
  ...
  //     {(context) => {this.props.persons.map((person, index) => {//DEVE-SE PASSAR AQUELE ARGUMENTO 'context' e então COLOCAR SEU CÓDIGO DENTRO DE UMA ARROW FUNCTION... ---> esse argumento/object 'context' SERÁ O MESMO que você escreveu acima desse código, será 'AuthContext'... ---> e você poderá usar TODAS AS PROPRIEDADES/VALORES DE 'AuthContext', desse objeto 'Context', NO COMPONENT 'Person' e no código jsx WRAPPADO por esse 'AuthContext.Consumer'...
  ...
  //       age={person.age} 
  //       changed={(event) => this.props.changed(event, person.id)}
  //       // isAuth={this.props.isAuthenticated} //não vamos repassar esse prop por meio desse approach, pois PODEMOS USAR ___CONTEXT__ OBJECTs __ para EVITAR REPASSE DE PROPS POR MÚLTIPLOS __LAYERS__ de COMPONENTS__.. --> evita redundâncias... ---> vamos usar um desses contexts, 'AuthContext', lá no component 'Person'....
