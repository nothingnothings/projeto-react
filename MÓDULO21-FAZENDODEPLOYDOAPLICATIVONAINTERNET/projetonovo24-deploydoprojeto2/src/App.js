...
class App extends Component {
  ...
  render() {
      ...
      let routes = (
        ...
        <Switch>
        {/* <Route path="/auth" component={Auth} />  /////ROUTE SEM LAZY LOADING. VER ROUTE ABAIXO, QUE USA LAZY LOADING.... --> lazy loading foi definido por meio do hoc de 'AsyncComponent'*/}
      ...
      if (this.props.token) {
        routes = (
          ...
          {/* ///////// 'auth '---> ROUTE ''desnecessária'' (supostamente, palavras do professor) READICIONADA __PARA QUE __ O CÓDIGO DE REDIRECT FUNCIONE... */}
          <Route path="/auth" component={AsyncAuth} /> 
