...
const BurgerIngredient = (props) => {
  ...
  switch (
    props.type ///sintaxe de 'switch()' ===== switch(parâmetro) {case(x): códigoASerExecutado}
  ) {
    case 'bread-bottom':
    ...
    default:
      ingredient = null; //isso aqui é o que ocorre quando o 'type' DENTRO DE PROPS É INVÁLIDO/NÃO EXISTE/NÃO FOI PASSADO... --> o ingredient será NULO, ou seja, NADA ACONTECERÁ/será renderizado..., pois não existirá elemento 'div' com className de 'null'...
  }
