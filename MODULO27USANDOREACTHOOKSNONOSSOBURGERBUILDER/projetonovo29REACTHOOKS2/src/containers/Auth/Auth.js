...
//     const updatedControls = updateObject(this.state.controls, {  ///uso da utility function de 'updateObject' para deixar o CÓDIGO UPDATADOR DE STATE DE FORMA 'safe' __ MAIS __LEAN__...
...
//         {this.state.isSignup ? (
//           <p>
//             Already have an account? Switch to Sign-in and enter with your
//             account!{' '}
//           </p>
//         ) : null}
//         {errorMessage}
...
const Auth = (props) => {
  ...
  const switchAuthModeHandler = () => {
    ...
    setIsSignup(!isSignup); ////NÃO SEI SE ESTÁ CERTO....
  };
  ...
  if (props.error) {
    errorMessage = (
      ...
      >
        {props.error.message.replaceAll('_', ' ')}
      </p>
    );
  }
