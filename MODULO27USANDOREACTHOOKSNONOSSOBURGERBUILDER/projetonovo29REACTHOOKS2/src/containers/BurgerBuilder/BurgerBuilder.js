...
//   //'export' ---> usado para TESTAR NOSSO CONTAINER, por meio daquele arquivo 'BurgerBuilder.test.js', que necessita desse 'named import' para rodar seus tests....
...
//     ///ESSA SERÁ A VERSÃO 'purchaseContinueHandler' USADA __ COM O APPROACH QUE UTILIZA 'REDUX'... (mais avançado).
...
//             ingredientAdded={(ingredientId) => {
//               this.props.onIngredientAdd(ingredientId);
//             }}
//             // ingredientRemoved={this.removeIngredientHandler}
//             ingredientRemoved={(ingredientId) => {
//               this.props.onIngredientRemove(ingredientId);
//             }}
      ...
      burger = (
        <Aux>
          ...
          <BuildControls
            ...
            price={props.price}
            ingredientAdded={(ingredientId) => {
              props.onIngredientAdd(ingredientId);
            }}
            ingredientRemoved={(ingredientId) => {
              props.onIngredientRemove(ingredientId);
            }}
...
const mapDispatchToProps = (dispatch) => {
  ...
  return {
    onIngredientAdd: (ingredientId) => {
      dispatch(actionsCreators.ingredient_add(ingredientId));
    },
    onIngredientRemove: (ingredientId) => {
      dispatch(actionsCreators.ingredient_remove(ingredientId));
    },
    onIngredientGet: () => {
      dispatch(actionsCreators.asyncOrderInitialIngredientsGet());
    },
    ...
    onSetAuthRedirectPath: (path) =>
      dispatch(actionsCreators.setAuthRedirectPath(path)),
    ...
    //   )
    // }
    onRedirectToHomeReset: () =>
      dispatch(actionsCreators.redirectToHomeResetter()),
  };
};
