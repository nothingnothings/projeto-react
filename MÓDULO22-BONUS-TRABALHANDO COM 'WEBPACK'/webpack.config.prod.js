...
// const webpack = require('webpack');
 ...
 module.exports = {
    ...
    plugins: [  
        ...
        //  new webpack.optimize.UglifyJsPlugin() //PLUGIN __BUILTIN__ no webpack... (HOJE EM DIA, ESSA CONFIGURAÇÃO NÃO PRECISA SER ADICIONADA; ELA RODA AUTOMATICAMENTE, ESTÁ 'BUILT-IN' NO WEBPACK, E É APLICADA QUANDO NOSSO 'MODE' ESTÁ SETTADO COMO 'production')
    ],
    output: {
        publicPath: '',
        filename: 'bundle.js',
