...
export class BurgerBuilder extends Component { //'export' ---> usado para TESTAR NOSSO CONTAINER, por meio daquele arquivo 'BurgerBuilder.test.js', que necessita desse 'named import' para rodar seus tests....
