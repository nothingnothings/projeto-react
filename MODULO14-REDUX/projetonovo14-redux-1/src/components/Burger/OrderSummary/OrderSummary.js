...
//     // const ingredientSummary = Object.keys(this.props.ingredients) ////////VERSÃO ALTERNATIVA DE NOSSO CÓDIGO MAIS ABAIXO. FOI A QUE O PROFESSOR UTILIZOU.
//     // .map( 
    ...
    console.log(ingredientSummary.flat(1))
        ...
        return (
            ...
            <ul>
                ...
                <li>{capitalizeFirstLetter(ingredientSummary[0][0])}: {props.ingredients.bacon}</li>
                <li>{capitalizeFirstLetter(ingredientSummary[1][0])}: {props.ingredients.cheese}</li>
                <li>{capitalizeFirstLetter(ingredientSummary[2][0])}: {props.ingredients.meat}</li>
                <li>{capitalizeFirstLetter(ingredientSummary[3][0])}: {props.ingredients.salad}</li>
            </ul>
