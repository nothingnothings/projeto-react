  ...
  render() {
    ...
    let form = (
      <div className={ContactDataStyle.ContactData}>
        ...
        <form 
        onSubmit={(event) => {  ///código ANTES DE USAR O REDUX com nosso projeto... ---> foi substituído pelo 'onBurgerAttempt', action dispatch realizado LÁ EMBAIXO, NO BUTTON, com o prop de 'clicked'...
